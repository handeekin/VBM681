 ...
 *
 * @author hande Jiang (hande.jiang@wisc.edu)
 * @version 2021-04-12
 */
public class LuceneBuildIndex {
    ...
    public static void main( String[] args ) {
        try {
            ...
            String pathCorpus = "/Users/hande/Downloads/example_corpus.gz";
            String pathIndex = "/Users/hande/Downloads/example_index_lucene";
            ...
            //config.setSimilarity( new CosineSimilarity() );
